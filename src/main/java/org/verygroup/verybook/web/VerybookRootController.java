...
//        specAudiobookUtil.setModel(request, currentUser, model);
        ...
        ratingItems.add(new RatingItem(false, 1, RatingSubcategory.ADVENTURES));
        ratingItems.add(new RatingItem(true, 4, RatingSubcategory.COOKING));
...
//        specAudiobookUtil.setModel(request, currentUser, model);
        ...
        switch (pageName) {
            ...
            case "book-price":
                ...
                break;
            case "offer":
                infoHeader = "ЛИЦЕНЗИОННЫЙ ДОГОВОР-ОФЕРТА";
                String infoBody1 =
                        "<p>\n" +
                        ...
                        "</p>\n" +
                        "<p class=\"indent\">\n" +
                        "   (Б) Размещение Лицензиатом Договора для всеобщего сведения по адресу <a href=\"info/offer\">verybook.org/info/offer</a> означает принятие Лицензиатом\n" +
