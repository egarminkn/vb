...
<c:set var="bookPublishDate" value="${fn:formatDate(bestSellersBookItem.bookPublishDate)}" scope="request"/>
...
<c:set var="bookPublishDate" value="${fn:formatDate(newBooksBookItem.bookPublishDate)}" scope="request"/>
...
<c:set var="bookPublishDate" value="${fn:formatDate(highestRatingBookItem.bookPublishDate)}" scope="request"/>
